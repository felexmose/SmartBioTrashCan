...
var idagBtn = document.getElementById("idagBtn");
var ugeBtn = document.getElementById("ugeBtn");
var årBtn = document.getElementById("årBtn");
var månedsGennemsnitBtn = document.getElementById("månedsGennemsnitBtn");
var Månedvalg = document.getElementById("Månedvalg");
var notifikationDiv = document.getElementById("notifikation");
var ugensMaxBtn = document.getElementById("størsteUge");
var ugensMinBtn = document.getElementById("mindsteUge");
var getRecipeBtn = document.getElementById("getRecipeBtn");
var searchRecipe = document.getElementById("searchRecipe");
var madOpskriftHistoBtn = document.getElementById("madOpskriftBtn");
...
//Api id og key
var Api_id = "766e4b4b";
var ApiKey = "7e6955147a2399b858406e2993bbdbd2";
...
function getAllRecipes() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/recipe")
...
function postRecipe(dato1, recipe1) {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post("https://restsmarttrashservice.azurewebsites.net/api/recipe", { dato: dato1, recipe: recipe1 })
        .then(function (response) {
...
function getRecipe() {
    ...
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://api.edamam.com/search?q=" + ApiKeyword + "&app_id=" + Api_id + "&app_key=" + ApiKey + "&from=0&to=1")
        .then(function (response) {
        console.log(response);
        //konvertere responsen til string ved hjælp af JSON.stringify
        var voresData = JSON.stringify(response.data);
        //det første og andet ord hvor response string skal splittes
        var firstWord = "\"ingredientLines";
        var secondWord = "\"ingredients\"";
        //index på respektiv splitte orde
        var index1 = voresData.indexOf(firstWord);
        var index2 = voresData.indexOf(secondWord);
        var newData = voresData.substring(index1, index2);
...
function plotIdag() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/1")
        .then(function (response) {
        console.log(response);
        var result = "<ul>";
        response.data.forEach(function (weight) {
...
function plotUge() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/2")
        .then(function (response) {
        console.log(response);
        var result = "<ul>";
        response.data.forEach(function (weight) {
...
function sortUgenEfterStørrelse(w) {
    var sortedList = new Array;
    /* sortere listen af weight objektor efter weight attributtet*/
    sortedList = w.sort(function (n1, n2) { return Number(n1.dato) - Number(n2.dato); });
    return sortedList;
}
function ugensMax() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/2")
        ...
        var sortedList = sortUgenEfterStørrelse(myList).reverse();
        var størsteDag = sortedList[0];
...
function ugensMin() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/2")
        ...
        var myList = new Array;
        myList = response.data;
        var sortedList = sortUgenEfterStørrelse(myList);
        var mindsteDag = sortedList[0];
...
function månedsGennemsnit() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/3")
        .then(function (response) {
        console.log(response);
        console.log("r i then");
        var result = new Array;
        response.data.forEach(function (weight) {
            var gram = Number(weight.dato);
            result.push(gram);
        });
        /*gå igennem result listen og lægger tallene sammen */
        var sum = result.reduce(function (a, b) { return a + b; }, 0);
        var myÅrMåned = (response.data[0].weightMeasure).substring(0, 7);
...
function plotÅr() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/4")
        .then(function (response) {
        console.log(response);
        var result = "<ul>";
        response.data.forEach(function (weight) {
...
function madSpildFaldet() {
    ...
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/2")
        ...
        /*gå igennem result listen og lægger tallene sammen */
        nuværendeUge = result.reduce(function (a, b) { return a + b; }, 0);
        _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://restsmarttrashservice.azurewebsites.net/api/weight/5")
            .then(function (response) {
            console.log(response);
            var result = new Array;
            response.data.forEach(function (weight) {
            ...
            /* gå igennem result listen og lægger tallene sammen */
            forrigeUge = result.reduce(function (a, b) { return a + b; }, 0);
